package com.mirea.klinevskayadm.notebook;
...
import com.mirea.klinevskayadm.notebook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void writeFileToExternalStorage() {
        ...
        File file = new File(path, binding.nameFile.getText() + ".txt");
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(file.getAbsoluteFile());
            OutputStreamWriter output = new OutputStreamWriter(fileOutputStream);
            output.write(String.valueOf(binding.quote.getText()));
            output.close();
        } catch (IOException e) {
    ...
    public void readFileFromExternalStorage() {
        ...
        try {
            ...
            binding.quote.setText(lines.toString());
        } catch (Exception e) {
